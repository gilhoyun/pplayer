...
public class MemberService {
	...
	public void joinMember(String loginId, String loginPw, String name, String email, byte[] profileImage) {
	    memberDao.joinMember(loginId, loginPw, name, email, profileImage);
	}
